...
**Before planning or building any non-trivial feature, redesign, or refactor, launch the `context-primer` agent first** and use its domain brief (vocabulary, ADR constraints) to inform the work. Skip only for trivial mechanical changes or pure code-location questions.
